...
public class DefaultJobManager implements JobManager {
  ...
  protected void hintAsyncExecutor(JobEntity job) {
    final AsyncJobAddedNotification jobAddedNotification = new AsyncJobAddedNotification(job, getAsyncExecutor());
    final TransactionContext transactionContext = Context.getTransactionContext();
